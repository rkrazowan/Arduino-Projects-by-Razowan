...
const char* ssid = "Road to 214";                   // edit your wifi SSID here
const char* password = "@@adhir767@@";            // edit your wifi password here
...
const uint8_t SCROLL_DELAY = 200;
...
"<html>" \
"<head>" \
"<title>Vertual Notice Board</title>" \
"<style>" \
"html, body" \ 
"{" \
"width: 600px;" \
